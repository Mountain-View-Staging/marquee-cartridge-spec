...
import { loadCartridgeWith, type DatabaseAdapter, type LoadOptions, type Opener } from "./loader.js";
 ...
 */
export const nodeSqliteOpener: Opener = (bytes: Uint8Array): DatabaseAdapter => {
...
export async function loadCartridge(bytes: Uint8Array, options?: LoadOptions & { readonly kind?: "surface" }): Promise<Snapshot>;
export async function loadCartridge(bytes: Uint8Array, options: LoadOptions & { readonly kind: "project" }): Promise<ProjectSnapshot>;
export async function loadCartridge(bytes: Uint8Array, options: LoadOptions = {}): Promise<Snapshot | ProjectSnapshot> {
