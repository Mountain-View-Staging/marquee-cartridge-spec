...
export function isPlayableType(contentType) {
...
export function fileIdFor(item, orientation) {
 ...
 */
export function playbackWindow(entry, item, file, orientation) {
    ...
    if (end !== null && end > start)
        return { start, duration: end - start, source: "window" };
    ...
    if (dwell !== null && dwell > 0)
        return { start, duration: dwell, source: "display_duration" };
 ...
 */
export function watchdogSeconds(window, file) {
